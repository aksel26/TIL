...
$("#m_1").css('color',"#ff0000")
$("#m_2").addClass("active")
$("img").first().attr('src','ch3.png');
$("<p></p>").html("항목4").appendTo("#m_4");
...
<p>DOM(Document Object Model)이란?<br>
웹페이지 문서를 조작하기 위해서 지켜야될 약속(interface)만 딸랑 적혀있는 문서랍니다.약속만 있을뿐 내부는 텅빈 상자랍니다.우리가 알고있는 W3C DOM에는 구현소스가 한줄도 존재하지 않습니다.그럼 실제 구현소스는??
			</p>
		</div>
	</div>
</body>
